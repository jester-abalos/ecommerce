...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Ensure all necessary fields are captured from the form
    // Optional fields that can be removed if not used
    $productSize = isset($_POST['productSizeInput']) ? $_POST['productSizeInput'] : null;
    $productType = isset($_POST['productTypeInput']) ? $_POST['productTypeInput'] : null;
    $productSkin = isset($_POST['productSkinInput']) ? $_POST['productSkinInput'] : null;
    $productBenefit = isset($_POST['productBenefitInput']) ? $_POST['productBenefitInput'] : null;
    $productMaining = isset($_POST['productMainingInput']) ? $_POST['productMainingInput'] : null;
    $productIng = isset($_POST['productIngInput']) ? $_POST['productIngInput'] : null;
    $productCount = 0;
        ...
        if (in_array($imageActualExt, $allowed)) {
            if ($imageError === 0) {
                if ($imageSize < 5000000) {
                    ...
                    $destination = __DIR__ . "/../img" . $imageNameNew;
...
<div class="Container">
    ...
    <nav class="nav-side" id="sidebar">
        ...
        <ul>
            ...
            <li class="active"><a href="./update.php">All Product</a></li>
            ...
            <div class="content">
                <div class="Column1">
                    ...
                    <div class="SKU-Stock">
                        <div class="SKU">
                            <h4>SKU</h4>
                            <input type="text" name="productSizeInput" placeholder="Fox-3983">
                        </div>
                        <div class="Stock">
                    ...
                    <div class="Reg_Price-Sales_Price">
                        <div class="Reg-Price">
                            <h4>Regular Price</h4>
                            <input type="text" name="productPriceInput" placeholder="₹200.00">
                        </div>
                    </div>
                    <h4>Tags</h4>
